local L = LibStub("AceLocale-3.0"):NewLocale("MMMGdkp", "ruRU")
...
L["MMMGdkp auction history"] = "MMMGdkp история торгов"
...
L["MMMGdkp version %s. Packaged %s."] = "MMMGdkp версии %s. Собрано %s."
