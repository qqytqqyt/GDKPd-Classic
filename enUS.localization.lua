...
local L = LibStub("AceLocale-3.0"):NewLocale("MMMGdkp", "enUS", true, debug)
...
While all other functionalities of MMMGdkp should still be compatible with previous versions, we |cffff0000strongly recommend updating MMMGdkp to version 1.2.0 or above|r.]=] ] = true
L["Enable"] = true
...
L["Frame alpha"] = true
L["Frame scale"] = true
L["MMMGdkp auction history"] = true
L["MMMGdkp auction history for %s"] = true
L[ [=[MMMGdkp: Drag to move
/MMMGdkp and check "Lock" to hide]=] ] = true
L["Loot dropped: "] = true
L["MMMGdkp: No detailed data available"] = true
L["This raid uses MMMGdkp to faciliate its GDKP bidding process. While you can bid on items without having MMMGdkp installed, installing it provides you with a GUI bidding panel, auto bidding functions, auction timers, chat filtering and more!"] = true
L["MMMGdkp version %s. Packaged %s."] = true
L["Your version of MMMGdkp is outdated and no longer compatible with the raid leader's in one or more functionalities. In order to ensure smooth performance, please update MMMGdkp."] = true
L["Your version of MMMGdkp is slightly outdated compared to the raid leader's. Full compability should be possible, however, you might want to take some time and update MMMGdkp."] = true
L["Hide"] = true
...
L["Notify raid members that do not have MMMGdkp installed"] = true
...
L["This player does not have MMMGdkp running or his version of MMMGdkp does not yet support version checks."] = true
L["This player has the same version of MMMGdkp as you do. Full compability is ensured."] = true
L["This player's version of MMMGdkp is more advanced than yours. Please consult your Curse Client for updates or manually check the curse.com page."] = true
L["This player's version of MMMGdkp is outdated and one or more functionalities are not compatible:"] = true
L["This player's version of MMMGdkp is outdated. However, their version should be fully compatible with yours."] = true
L["This version of MMMGdkp was never functional due to internal errors."] = true
...
L["This version will be unable to recognize version check requests by you. Version check requests sent by this version of MMMGdkp will not be answered."] = true
...
Do you want MMMGdkp to announce loot?]=] ] = true
